...
export default async function handler(
    ...
    await pool.query('INSERT INTO sell(user_id, selected_game, amount, price, charname, title, content, selected_server) VALUES(?,?,?,?,?,?,?,?)', [userId, selectedGame, parsedAmount, parsedPrice ,charName ,title, content, selectedServer ]);
